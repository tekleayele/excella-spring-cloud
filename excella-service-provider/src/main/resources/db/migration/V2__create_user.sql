...
ALTER TABLE IF EXISTS USER_ACCOUNT ADD CONSTRAINT USER_USER_NAME UNIQUE (USER_NAME);
...
ALTER TABLE IF EXISTS USERS_AUTHORITIES ADD CONSTRAINT USERS_AUTHORITIES_USER_ACCOUNT
